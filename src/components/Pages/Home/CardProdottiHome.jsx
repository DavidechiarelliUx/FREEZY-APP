...
const CardProdottiHome =() => {
    ...
    const prodottiInScadenza = prodotti.sort((a, b) => a.scadenza - b.scadenza).slice(0, 10);

    console.log(prodottiInScadenza);
        ...
        <>
          {prodottiInScadenza.map((elem) => {
            ...
            return (
              ...
              >
                <Card.Img variant="top" src={elem.image} alt={elem.nomeProdotto} style={{ width: "30px", height: "30px" }} className="mx-1" />
